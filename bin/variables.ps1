...
$elxVersion = "1.20.1"
$elxBuildUri = "https://github.com/elixir-lang/elixir/releases/download/v${elxVersion}/elixir-otp-27.zip"
...
$java21Build = "zulu21.52.203-ca-jdk21.0.12.1-win_x64"
